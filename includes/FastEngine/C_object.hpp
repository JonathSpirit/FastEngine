...
public:
    ...
    virtual void first(fge::Scene* scene_ptr=FGE_OBJ_NOSCENE);
    virtual void callbackRegister(fge::Event& event);
    virtual void update(sf::RenderWindow& screen, fge::Event& event, const std::chrono::milliseconds& deltaTime, fge::Scene* scene_ptr=FGE_OBJ_NOSCENE);
    virtual void draw(sf::RenderTarget& target, sf::RenderStates states) const override;
    virtual void networkRegister();
    virtual void removed(fge::Scene* scene_ptr=FGE_OBJ_NOSCENE);

    virtual void save(nlohmann::json& jsonObject, fge::Scene* scene_ptr=FGE_OBJ_NOSCENE);
    virtual void load(nlohmann::json& jsonObject, fge::Scene* scene_ptr=FGE_OBJ_NOSCENE);
